...
const About = () => {
    return (
        <section id="section2" className="section flex flex-col justify-center min-h-screen w-full text-[#a767b5] text-center px-15 xl:px-40 lg:px-30 md:px-20">
            <div className='flex justify-center'><AnimatedAbout/></div>
