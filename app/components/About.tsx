...
const About = () => {
    return (
        <section className="section flex justify-center flex-col place-self-center items-center min-h-screen w-[clamp(300px,80vw,800px)] text-[#d1a8da] text-center">
            ...
            <h1 className="text-5xl font-(family-name:--font-meow-script) my-5 font-extrabold">Proficiencies</h1><br />
            <div className='bg-[#ffffffaa] rounded-md flex flex-row overflow-x-scroll p-5 border-2 border-[#b18ad8] w-[clamp(300px,80vw,500px)] space-x-5'>
