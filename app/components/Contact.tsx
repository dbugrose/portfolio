...
const Contact = () => {
  return (
        ...
        <p className='text-[clamp(18px,2vw,2vw)]'><span className='text-[clamp(18px,3vw,3vw)] font-(family-name:--font-meow-script) text-shadow-xs text-shadow-[#4f1254]'>GitHub:</span>  <a href="https://www.github.com/dbugrose/">github.com/dbugrose</a></p>
